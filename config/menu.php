...
Menu::macro('sidebar', function () {
    return Menu::adminlteMenu()
        ->add(Html::raw('MAIN FEATURE')->addParentClass('header'))
...
//        ->url('http://www.google.com', 'Google')
        ->add(Menu::adminlteSeparator('SOFTWARE CONFIG'))
        ->link('HomeController@index', '<i class="fa fa-home"></i><span>Home</span>')
        #adminlte_menu
        ->add(Menu::adminlteSeparator('REPORTING'))
